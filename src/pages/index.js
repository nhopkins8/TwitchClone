    ...
    <div className="min-h-screen bg-gray-900">
      <nav className="flex items-center bg-gray-900 text-white text-xl h-12 font-thin font-normal w-full">
        ...
        <div className="w-64 flex w-full justify-center">
          <input className="rounded-l w-1/2 bg-gray-800 h-8 pl-4 pr-8 border-2 border-gray-800 outline-none text-sm focus:border-purple-600 focus:outline-none focus:bg-black focus:border-purple-500" style={{marginRight: '1px'}} />
